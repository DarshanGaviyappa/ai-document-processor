"""
Convert extracted content to Markdown using Docling
"""
import json
...
def convert_with_docling(input_path: str, output_path: str = None) -> Dict[str, Any]:
    """
    Convert file to Markdown using Docling
    
    Args:
        input_path: Path to input file (PDF, etc.)
...
if __name__ == "__main__":
    ...
    if Path(pdf_path).exists():
        ...
        output_md = f"data/converted_docling_{timestamp}.md"
        
        result = convert_with_docling(pdf_path, output_md)
